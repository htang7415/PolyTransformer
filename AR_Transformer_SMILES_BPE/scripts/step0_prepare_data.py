...
def main(args):
    ...
    bpe_cfg = tokenizer_cfg.get('bpe', {})
    tokenizer = PSmilesTokenizer(
        max_length=tokenizer_cfg['max_length'],
        bpe_vocab_size=bpe_cfg.get('vocab_size', tokenizer_cfg.get('vocab_size', 512)),
        min_frequency=bpe_cfg.get('min_frequency', 2),
        max_corpus_size=bpe_cfg.get('max_corpus_size', 200000),
